const TermsAndConditions = () => {
  return (
    <div className="p-5 mx-5">
      ...
      <p>Welcome to Thapar Events!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Thapar Events's Website, located at https://thaparevents.vercel.app/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Thapar Events if you do not agree to
      ...
      <p>
        Unless otherwise stated, Thapar Events and/or its licensors own the
        intellectual property rights for all material on Thapar Events. All
        intellectual property rights are reserved. You may access this from
        Thapar Events for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Thapar Events</li>
        <li>Sell, rent or sub-license material from Thapar Events</li>
        <li>Reproduce, duplicate or copy material from Thapar Events</li>
        <li>Redistribute content from Thapar Events</li>
      </ul>
      ...
      <p>
        ...
        Thapar Events does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Thapar Events,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Thapar Events shall not be
      ...
      <p>
        Thapar Events reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Thapar Events a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Thapar Events; and (d) the link
      ...
      <p>
        ...
        e-mail to Thapar Events. Please include your name, your organization
      ...
      <p>
        No use of Thapar Events's logo or other artwork will be allowed for
