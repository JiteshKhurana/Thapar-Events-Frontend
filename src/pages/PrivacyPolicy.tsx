const PrivacyPolicy = () => {
  return (
    <div className="p-5 mx-5">
      ...
      <p className="text-sm text-right mb-4">Last updated: April 28, 2024</p>
      <p className="mb-4">
      ...
      <ul className="list-disc pl-5 mb-4">
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Thapar Events.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Thapar Events, accessible from{" "}
            <a
              href="https://thaparevents.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://thaparevents.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <h3 className="text-xl font-semibold mb-3">Delete Your Personal Data</h3>
      <p>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://thaparevents.vercel.app/Feedback"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://thaparevents.vercel.app/Feedback
          </a>
        </li>
      </ul>
    </div>
