          ...
          {societies.map((society) => (
            ...
            >
              <div className="bg-black bg-opacity-30">
                ...
                <CardHeader>
                  <CardTitle>
                    <img src="https://res.cloudinary.com/dhrfyg57t/image/upload/v1712308980/ccs_logo_hq2ysz.jpg" className="w-40  mx-auto " />
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="flex justify-center mt-5">
                    <p className=" text-white text-lg font-semibold">{society.name}</p>
                  </div>
                </CardContent>
                <CardFooter>
                  <Button
