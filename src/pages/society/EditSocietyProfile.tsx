...
const EditSocietyProfile: React.FC = () => {
  return (
    <div className="bg-[#f1f1f1] flex flex-col items-center">
      <div className="heading flex items-center gap-4 py-4">
        ...
        <Button className="bg-[#265073]">Preview</Button>
      </div>
      <div
        style={{
          backgroundImage:
      ...
      >
        ...
        <div className="societynameandimg flex items-center gap-5 ml-10 mb-5">
          <div
            ...
            className="societyimg w-[150px] h-[150px] bg-black rounded-full border-2 border-white flex justify-center items-center"
          >
            <BiPencil className="text-5xl text-white" />
          </div>
      ...
      <div className="editorcontainer w-[80%] my-5 min-h-[100vh] bg-white rounded-lg px-5 py-3">
        ...
        <div className="photogallery border-[1px] h-[400px] rounded-md my-3"></div>
        ...
        <Button className="bg-[#265073] p-5 hover:bg-slate-900">
      ...
      <div className="savchanges w-full  bg-white border-y-2 flex justify-between items-center px-10 py-5">
        <Button className="bg-white text-black rounded-sm p-6 border-2 hover:bg-gray-300">
          Cancel
        </Button>
