  ...
  return (
    <div className="w-full min-h-[100vh] bg-gray-0">
        <div className="heading flex flex-wrap gap-3 p-6 mt-3">
            ...
            <Button className="flex items-center">Add registration<BiPlus className="text-xl"/></Button>
        ...
        <div className="searchbar p-7 flex flex-wrap items-center gap-3">
            ...
            <span>Total Registrations: <span className="font-semibold">234</span></span>
        </div>
