  ...
  return (
    <div className="bg-[#265073] w-full flex flex-col items-center py-10 text-white">
      <div className="conatainer flex flex-col items-center justify-center">
        ...
        <span className="college-heading text-sm sm:text-xl font-semibold pb-3 border-b-2 flex justify-center items-center px-3">Thapar Institute of Engineering and Technology</span>
        {/* <Separator className=""/> */}
